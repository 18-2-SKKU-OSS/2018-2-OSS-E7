...
#    course_suffix: ""
  ...
  teachers_quote:
    subtitle: "한 시간 안에 학생들은 시작할 수 있습니다. 학생들이 컴퓨터 과학을 배우면서 <strong> 수업을 만들고, 학생을 추가하고, 진행 상황을 모니터 </ strong> 할 수 있습니다."
    email_exists: "존재하는 이메일입니다."
    phone_number: "전화 번호"
    phone_number_help: "연락하기 가장 좋은 전화번호는 무엇입니까?"
    primary_role_label: "기본 역할"
    role_default: "역할 선택"
    primary_role_default: "기본 역할 선택"
    purchaser_role_default: "구매자 역할 선택"
    tech_coordinator: "기술 코디네이터"
    advisor: "커리큘럼 전문가 / 고문"
    principal: "교장"
    superintendent: "교육감"
    parent: "부모님"
    purchaser_role_label: "구매자 역할"
    influence_advocate: "영향력 / 옹호자"
    evaluate_recommend: "평가 / 권장"
    approve_funds: "지금 승인하기"
    no_purchaser_role: "구매 결정 의사 없음."
    district_label: "거주지"
    district_name: "거주지 이름"
    district_na: "해당 사항이 없으면 N / A 입력"
    organization_label: "학교"
    school_name: "학교 이름"
    city: "도시"
    state: "주"
    country: "나라"
    num_students_help: "얼마나 많은 학생이 CodeCombat을 사용하나요?"
    num_students_default: "범위 선택"
    education_level_label: "학생의 교육 수준"
    education_level_help: "최대한 많이 선택하십시오."
    elementary_school: "초등학교"
    high_school: "고등학교"
    please_explain: "(설명해주세요)"
    middle_school: "중학교"
    college_plus: "대학 이상"
    referrer: "우리를 어떻게 알게 되었습니까?"
    referrer_help: "예): 다른 선생님으로부터, 학회로부터, 학생으로부터, Code.org, 등."
    referrer_default: "하나만 선택하시오"
    referrer_hoc: "Code.org/Hour of Code"
    referrer_teacher: "선생님"
    referrer_admin: "관리자"
    referrer_student: "학생"
    referrer_pd: "전문 교육 / 워크숍"
    referrer_web: "Google"
    referrer_other: "기타"
    anything_else: "CodeCombat을 사용하여 어떤 종류의 수업을 기대합니까?"
    thanks_header: "요청 완료!"
    thanks_sub_header: "CodeCombat에 관심을 가져 주셔서 감사합니다."
    thanks_p: "곧 연락을 드릴 것입니다. 문의가 필요하면 다음 주소로 연락하십시오 :"
    back_to_classes: "수업으로 돌아가기"
...
#    student_email_invite_blurb: "Your students can also use class code <strong>__classCode__</strong> when creating a Student Account, no email required."
    ...
    back_courses: "내 수업으로 돌아가기"
    edit_details: "수업 정보 편집"
    purchase_enrollments: "학생 라이센스를 구입"
    remove_student: "학생을 제거"
    assign: "지정"
    to_assign: "완납한 수업을 지정."
    student: "학생"
    teacher: "교사"
    arena: "아레나"
    ...
    practice: "연습"
    required: "필수"
    welcome_to_courses: "모험가들, 여정에 오신걸 환영합니다!"
    ready_to_play: "준비되었습니까?"
    start_new_game: "새 게임 시작"
    play_now_learn_header: "지금 시작하세요"
#    play_now_learn_1: "basic syntax to control your character"
    play_now_learn_2: "while문을 써서 성가신 문제를 푸세요"
    play_now_learn_3: "문자열 & 변수를 써서 행동을 꾸미세요"
    play_now_learn_4: "거인을 무찌르는 법(중요한 삶의 기술!)"
    welcome_to_page: "내 학생의 대시보드"
    my_classes: "현재 클래스"
    class_added: "클래스가 성공적으로 추가되었습니다!"
    view_levels: "모든 레벨 보기"
    view_project_gallery: "내 동료들의 프로젝트 보기"
    join_class: "클래스 참가"
    join_class_2: "클래스 참가"
    ask_teacher_for_code: "선생님께 CodeCombat 클래스 코드가 있는지 물어보세요! 있으면, 밑에다 입력하세요:"
    enter_c_code: "<클래스코드 입력>"
    join: "참가"
    joining: "클래스 참가중"
    course_complete: "수업 완료"
    play_arena: "아레나 진입"
    view_project: "프로젝트 확인"
    start: "시작"
    last_level: "가장 최근에 플레이한 레벨"
    not_you: "당신이 아닙니까?"
    continue_playing: "계속 진행"
    option1_header: "학생들을 이메일을 통해 초대"
    remove_student1: "학생 제거"
    are_you_sure: "이 학생을 클래스에서 제거하겠습니까?"
